def flexslider():
    f = open('Desktop/LFP_Proyecto2/js/flexslider.css', 'w')
    mensaje = '''@font-face {
...
#-------------------------------------------------------------------------------------------------------------
def jquery_ui():
    f = open('Desktop/LFP_Proyecto2/js/jquery-ui.css', 'w')
...
.ui-widget-content {/*color del contenido de la pestaña*/
...
.ui-widget-header {/*color contenedor de pestañas*/
	border: 1px solid #dddddd;
...
html .ui-button.ui-state-disabled:active {/*color de las pestañas desactivadas*/
	border: 1px solid #c5c5c5;
...
a:link.ui-button,
a:visited.ui-button,
.ui-button {/*Color de la fuente, pestaña desactivada*/
	color: #5C0001;
	text-decoration: none;
}
.ui-state-hover,
...
.ui-button:hover,
.ui-button:focus {/*-Pestaña con el puntero encima*/
...
a.ui-button:hover,
a.ui-button:focus {/*-Color de fuente de pestaña desactivada*/
	color: #2C0000;
	text-decoration: none;
}
