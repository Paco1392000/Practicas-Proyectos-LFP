def jquery_flexslider():
	f = open('Desktop/LFP_Proyecto2/js/jquery.flexslider.js', 'w')
	mensaje = '''/*
...
#-------------------------------------------------------------------------------------------------------------  
def main():
	f = open('Desktop/LFP_Proyecto2/js/main.js', 'w')
...
#-------------------------------------------------------------------------------------------------------------
def prueba():
	f = open('Desktop/LFP_Proyecto2/js/prueba.js', 'w')
	mensaje = '''function activarTab(unTab) {
    try {
